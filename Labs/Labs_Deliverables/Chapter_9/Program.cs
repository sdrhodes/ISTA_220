...
namespace StructsAndEnums
{
    class Program
    {
        static void doWork()
        {
            ...
            Date weddingAnnversaryCopy = weddingAnniversary;
            Console.WriteLine($"Value of copy is {weddingAnnversaryCopy}");
            weddingAnniversary.AdvanceMonth();
            Console.WriteLine($"New value of weddingAnniversary is {weddingAnniversary}");
            Console.WriteLine($"Value of copy is still {weddingAnnversaryCopy}");
        }
